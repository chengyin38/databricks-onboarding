...
# MAGIC %md
# MAGIC 🤗 Transformers pipelines make it easy to define and encapsulate all of the required components for a particular task. The MLflow flavor for `transformers` directly supports saving and loading of `Pipelines`. 
