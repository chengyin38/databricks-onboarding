...
test_dataset = datasets.Dataset.from_spark(test_df, cache_dir="/dbfs/cache/test", split="test")
...
train_dataset = train_tokenized["train"].shuffle(seed=42)
test_dataset = test_tokenized["test"].shuffle(seed=42)
